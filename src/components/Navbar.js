    ...
    return (
        <Wrapper className='section-center'>
            ...
            <div className='links'>
                ...
                {token && <Link activeClassName="active-link" to='/cart'>Cart</Link>}
                {token && <Link activeClassName="active-link" to='/orders'>Orders</Link>}
            </div>
            ...
            <div className='menu'>
                ...
                {   isOpen &&
                    <div>
                        ...
                        {token && <Link activeClassName="active-link" to='/cart' onClick={() => setIsOpen(false)}>Cart</Link>}
                        {token && <Link activeClassName="active-link" to='/orders' onClick={() => setIsOpen(false)}>Orders</Link>}
                        {
                            !token ?
                                <>
